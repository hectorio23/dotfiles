...
static const char *fonts[]          = {"CaskaydiaCove Nerd Font:style:regular:size=11" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_r,       spawn,          SHCMD("redshift -O 5400")},
    { MODKEY|ShiftMask,                 XK_r,       spawn,          SHCMD("redshift -x")},

    { MODKEY,                           XK_i,       spawn,          SHCMD("idea")},
    { MODKEY|ShiftMask,                 XK_p,       spawn,          SHCMD("packettracer")},

    { MODKEY|ShiftMask,                 XK_l,       spawn,          SHCMD("i3lock-fancy -f Caskaydia-Cove-Nerd-Font-Complete-Bold")},
